        ...
        for object_type, object_tracks in tracks.items():
            ...
            for frame_num in range(0, number_of_frames, self.frame_window):
                ...
                for track_id, _ in object_tracks[frame_num].items():
                    # Check if the player exists in the 'last_frame' of this window
                    if track_id not in object_tracks[last_frame]:
                        continue

                    # Use .get() to safely retrieve coordinates
                    ...
                    # If either position is missing, skip this window
                    ...
                    if time_elapsed <= 0: continue # Prevent division by zero
                    ...
                    # Apply values to the frames within this window
